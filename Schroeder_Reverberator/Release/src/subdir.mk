...
src/Main.doj: ../src/Main.c
	...
	cc21k -c -file-attr ProjectName="Schroeder_Reverberator" -proc ADSP-21489 -flags-compiler --no_wrap_diagnostics -si-revision 0.2 -O -Ov100 -DCORE0 -DNDEBUG -DDO_CYCLE_COUNTS @includes-87f18efc813b34215c1088035b20b383.txt -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -swc -gnu-style-dependencies -MD -Mo "src/Main.d" -o "$@" "$<"
...
src/SPORT1_ISR_process_samples_.doj: ../src/SPORT1_ISR_process_samples_.asm
	...
	easm21k -file-attr ProjectName="Schroeder_Reverberator" -proc ADSP-21489 -si-revision 0.2 -DCORE0 -DNDEBUG @includes-8298c3f6f5dfdfc1c54920975249a04d.txt -swc -gnu-style-dependencies -MM -Mo "src/SPORT1_ISR_process_samples_.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
